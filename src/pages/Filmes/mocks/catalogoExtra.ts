import type { CatalogoExtra } from '../catalogoData';

export const DEFAULT_CATALOGO_EXTRA: CatalogoExtra = {
  count: 0,
...
export const CATALOGO_EXTRA_BY_FILME: Record<number, CatalogoExtra> = {
  1: {
    count: 380,
